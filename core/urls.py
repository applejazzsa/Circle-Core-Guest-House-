...
urlpatterns = [
    ...
    path("bookings/add-group/", views.group_booking_add, name="group_booking_add"),
    path("rooms/<int:pk>/availability.json", views.room_availability_json, name="room_availability_json"),

...
SECRET_KEY = "django-insecure-circle-core-guest-house-dev-key"

DEBUG = True

ALLOWED_HOSTS = []

GUEST_HOUSE_NAME = "Circle Core Guest House"
...
# ── Email (dev: print to console; set SMTP vars to send real emails) ──
import os
...
DEFAULT_FROM_EMAIL = os.environ.get(
    "DEFAULT_FROM_EMAIL", "Circle Core Guest House <noreply@circlecoreguest.house>"
)
